...
export function DataTableFilter<TData>({
    ...
    return (
        <>
            <Select onValueChange={(value) => setFilteredColumn(value)}>
                <SelectTrigger className="w-[180px]">
                    <SelectValue placeholder={<span className="font-medium">Filter column...</span>} />
                </SelectTrigger>
                <SelectContent>
                    <SelectGroup>
...
export function DataTablePagination<TData>({
    ...
    return (
        <div className="max-md:grid max-md:gap-2 md:flex items-center justify-between px-2 py-2 ">
...
export function DataTableColumnHeader<TData, TValue>({
    ...
    if (title === undefined) title = column.id
